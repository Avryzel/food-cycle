...
export default function CookPage() {
    ...
    const [preferenceText, setPreferenceText] = useState("Berkuah, pedas, cocok untuk makan siang");
                    ...
                    <div className="lg:col-span-8 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3 max-h-[460px] overflow-y-auto pr-1 pb-10 sm:pb-0">
                            {filteredIngredients.length > 0 ? (
                                ...
                                <div className="col-span-2 text-center py-12 text-sm font-bold text-zinc-400">
                ...
                <div className="w-full bg-white border border-zinc-100 rounded-3xl p-6 md:p-8 space-y-6 shadow-xl shadow-zinc-900/5 animate-fade-in">
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full p-4 bg-zinc-50/50 border border-zinc-200 rounded-2xl text-sm font-medium text-zinc-800 focus:outline-none focus:ring-2 focus:ring-[#8EBA85]/20 focus:border-[#8EBA85] min-h-[120px] transition-all"
                        />
                    </div>
            ...
            <div className="fixed sm:static bottom-0 left-0 w-full sm:w-auto bg-white sm:bg-transparent p-4 sm:p-0 border-0 flex justify-end gap-3 z-40">
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        else alert("Sistem Siap! Mengirim data bahan ke OpenAI API 🚀");
                    }}
